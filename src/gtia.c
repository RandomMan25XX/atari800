...
DTCM_DATA UBYTE GTIA_M0PL;
DTCM_DATA UBYTE GTIA_M1PL;
DTCM_DATA UBYTE GTIA_M2PL;
DTCM_DATA UBYTE GTIA_M3PL;
DTCM_DATA UBYTE GTIA_P0PL;
DTCM_DATA UBYTE GTIA_P1PL;
DTCM_DATA UBYTE GTIA_P2PL;
DTCM_DATA UBYTE GTIA_P3PL;
DTCM_DATA UBYTE GTIA_HPOSP0;
DTCM_DATA UBYTE GTIA_HPOSP1;
DTCM_DATA UBYTE GTIA_HPOSP2;
DTCM_DATA UBYTE GTIA_HPOSP3;
DTCM_DATA UBYTE GTIA_HPOSM0;
DTCM_DATA UBYTE GTIA_HPOSM1;
DTCM_DATA UBYTE GTIA_HPOSM2;
DTCM_DATA UBYTE GTIA_HPOSM3;
DTCM_DATA UBYTE GTIA_SIZEP0;
DTCM_DATA UBYTE GTIA_SIZEP1;
DTCM_DATA UBYTE GTIA_SIZEP2;
DTCM_DATA UBYTE GTIA_SIZEP3;
DTCM_DATA UBYTE GTIA_SIZEM;
DTCM_DATA UBYTE GTIA_GRAFP0;
DTCM_DATA UBYTE GTIA_GRAFP1;
DTCM_DATA UBYTE GTIA_GRAFP2;
DTCM_DATA UBYTE GTIA_GRAFP3;
DTCM_DATA UBYTE GTIA_GRAFM;
DTCM_DATA UBYTE GTIA_COLPM0;
DTCM_DATA UBYTE GTIA_COLPM1;
DTCM_DATA UBYTE GTIA_COLPM2;
DTCM_DATA UBYTE GTIA_COLPM3;
DTCM_DATA UBYTE GTIA_COLPF0;
DTCM_DATA UBYTE GTIA_COLPF1;
DTCM_DATA UBYTE GTIA_COLPF2;
DTCM_DATA UBYTE GTIA_COLPF3;
DTCM_DATA UBYTE GTIA_COLBK;
DTCM_DATA UBYTE GTIA_PRIOR;
DTCM_DATA UBYTE GTIA_VDELAY;
DTCM_DATA UBYTE GTIA_GRACTL;
